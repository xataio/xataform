...
export default function Home() {
  ...
  const redirectUrl: LinkProps["href"] = "/forms";
  return (
    <>
      <Head>
        <title>XataForm</title>
        <meta
          name="description"
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Create, edit and share any forms you want!
                </p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  {isSignedIn ? (
                    <CTAButton href="/forms">Go to dashboard</CTAButton>
                  ) : (
                  ...
                  <a
                    href="https://github.com/xataio/xataform"
...
function CTAButton({
  href,
  ...props
}: React.PropsWithChildren & { href?: LinkProps["href"] }) {
  const className =
